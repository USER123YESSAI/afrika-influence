// Design System - Afrika Influence
...
export const inputStyles = {
  base: 'border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all',
  error: 'border-red-300 focus:ring-red-500 focus:border-red-500',
};

export const tableStyles = {
  base: 'w-full text-sm text-left',
  header: 'bg-gray-50 text-gray-700 font-semibold text-xs uppercase tracking-wider',
